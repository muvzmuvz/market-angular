...
export class StorePage {
  ...
  ngOnInit(): void {
    ...
    // Пример безопасного вызова requestAnimationFrame
    this.callAnimationFrameSafely();
  }
  ...
  private callAnimationFrameSafely(): void {
    if (isPlatformBrowser(this.platformId)) {
      requestAnimationFrame(() => {
        console.log('requestAnimationFrame выполнен — мы в браузере');
      });
    } else {
      console.log('requestAnimationFrame не доступен — это сервер');
    }
  }
}
